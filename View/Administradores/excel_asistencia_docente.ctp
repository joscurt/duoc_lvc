<?php
	...
	$objPHPExcel->setActiveSheetIndex()->setCellValue('C2', !empty($docente)?"Docente: ".utf8_encode($docente['Docente']['NOMBRE']).' '.utf8_encode($docente['Docente']['APELLIDO_PAT']).' '.utf8_encode($docente['Docente']['APELLIDO_MAT']):null);
