...
<div class="card" id="header-fixed" style="left: 1%;position: fixed;right: 1%;top: 12%;z-index: 999;">
	<div class="card-padding card-body">
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="form-group">
					<label for=""><i class="fa fa-calendar-check-o"></i>&nbsp;&Uacute;ltmio registro guardado por el docente:</label>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="col-md-12" style="margin-top: 1%;">
					...
					<div class="col-md-4">
						<strong>&Uacute;ltmio registro guardado por el docente:</strong>&nbsp;&nbsp;
