<form id="form_ajax_edit_recuperar_atraso_retiro" method="POST">
	...
	<div class="modal-footer">
		<a 
			send-ajax="true"
			type-response="json"
			href="<?php echo $this->Html->url(array('action'=>'editarRecuperarAtrasoRetiro',$motivo_bd['RecuperarAtrasoRetiro']['COD'])); ?>"
