<form method="POST">
	<div class="modal-header" >
		...
		<h4 style="border-bottom: 1px solid #0c253d; padding-bottom: 5px;" class="modal-title">Nuevo Motivo Rechazo Clase</h4>
	</div>
	<br>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="form-group">
					...
					<input type="text" name="data[Rechazo][MOTIVO]" class="form-control input_motivo" placeholder="Ingrese nombre del motivo">
				</div>
			</div>
		</div>
	</div>
