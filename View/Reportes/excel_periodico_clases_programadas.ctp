<?php
	...
	$objPHPExcel->getProperties()->setCreator("LISTADO PERIODICO DE CLASES ADELANTAS / RECUPERADAS: ".date('dmYH:i'))
                     ->setLastModifiedBy("LVC")
                     ->setTitle("LISTADO PERIODICO DE CLASES ADELANTAS / RECUPERADAS: ".date('dmYH:i'))
                     ->setSubject("LISTADO")
                     ->setDescription("Listado PERIODICO DE CLASES ADELANTAS / RECUPERADAS")
                     ->setKeywords("office 2007 openxml php")
                     ->setCategory("Listado PERIODICO DE CLASES ADELANTAS / RECUPERADAS");
                 	##
