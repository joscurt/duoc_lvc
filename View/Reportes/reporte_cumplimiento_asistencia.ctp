...
<div class="row m-t-20">
	<form 
		...
		<div class="col-md-2">
			<div class="form-group">
				<label for="">Rut Docente <span title="Se desplegará un listado de opciones coincidentes con su búsqueda." data-toggle="tooltip"><i class="fa fa-info-circle"></i></span></label>
				<input
					class="form-control autocompletable-input" 
					type="text"
