...
<table style="border-bottom:1px solid #ccc;">
	<tr >
		...
		<td><h4 class="titulo">N&Oacute;MINA DIARIA DE CLASES A RECUPERAR Y ADELANTAR</h4></td>
	</tr>
</table>
<br>
		...
		<table class="table">
			...
			<tbody>
				<?php if (isset($registros)): ?>
					...
					foreach ($registros as $key => $detalle): ?>
						<tr>
							...
							<td><?php echo htmlspecialchars($detalle['ProgramacionClase']['SALA']); ?></td>
