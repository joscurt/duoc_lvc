		...
		<div class="form-group">
			<form id="form-exportar" method="POST" target="_blank">
				...
				<button 
					...
					href="<?php echo $this->Html->url(array('action'=>'excelTasaAsistencia')); ?>"
					><i class="fa fa-file-excel-o"></i>&nbsp;Exportar Excel</button>
				<button 
					class="btn btn-success btn-exportable" 
					href="<?php echo $this->Html->url(array('action'=>'pdfTasaAsistencia')); ?>"
					><i class="fa fa-file-pdf-o"></i>&nbsp;Exportar PDF</button>
				<button 
					class="btn btn-success btn-exportable" 
					target="_blank"
					href="<?php echo $this->Html->url(array('action'=>'imprimirTasaAsistencia')); ?>"
