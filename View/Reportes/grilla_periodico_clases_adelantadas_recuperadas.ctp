<div class="row">
	<div class="col-md-12">
		...
		<label for="" class="">Ordenar por:</label>
			<select name="data[Filter][ordenar]" id="select-order" class="form-control selectpicker" data-live-search="true">
				...
				<option value="Sala.TIPO_SALA, SalaReemplazo.TIPO_SALA" <?php echo $ordenar == 'Sala.TIPO_SALA, SalaReemplazo.TIPO_SALA' ? 'selected="selected"':''; ?>>Sala</option>
	...
	<div class="col-md-12">
		<div class="form-group">
			<form id="form-exportar" method="POST">
				<?php 
				...
				<button 
					...
					href="<?php echo $this->Html->url(array('action'=>'excelPeriodicoClasesAdelantadasRecuperadas')); ?>"
					><i class="fa fa-file-excel-o"></i>&nbsp;Exportar Excel</button>
				<button 
					class="btn btn-success btn-exportable" 
					href="<?php echo $this->Html->url(array('action'=>'pdfPeriodicoClasesAdelantadasRecuperadas')); ?>"
					><i class="fa fa-file-pdf-o"></i>&nbsp;Exportar PDF</button>
				<button 
					class="btn btn-success btn-exportable" 
					target="_blank"
					href="<?php echo $this->Html->url(array('action'=>'imprimirPeriodicoClasesAdelantadasRecuperadas')); ?>"
