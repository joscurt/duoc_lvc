<div class="row">
	<div class="col-md-12">
		<h2 style="border-bottom: 1px solid #0c253d; padding-bottom: 5px;"><label>Tasa de Asistencia y RI del Alumno</label></h2>				
	</div>
</div>
<div class="row m-t-20">
	<form 
		id="form-filtro-basico" 
		action="<?php echo $this->Html->url(array('action'=>'grillaTasaAsistencia')); ?>" 
		method="POST">
		<div class="col-md-2">
