...
<table style="border-bottom:1px solid #ccc;">
	<tr >
		...
		<td><h4 class="titulo">NÓMINA DIARIA DE CLASES PROGRAMADAS</h4></td>
	</tr>
</table>
<br>
				...
				<?php if (isset($registros)): ?>
					<?php foreach ($registros as $key => $detalle): ?>
						<tr>
							...
							<td><?php echo date('H:m', strtotime($detalle['ProgramacionClase']['HORA_INICIO'])).' - '.date('H:m', strtotime($detalle['ProgramacionClase']['HORA_FIN'])); ?></td>
