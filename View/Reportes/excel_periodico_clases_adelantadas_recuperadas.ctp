<?php
	...
	$objPHPExcel->setActiveSheetIndex()->setCellValue('B2', "REPORTES PERIÓDICOS DE CLASES ADELANTADAS Y RECUPERADAS (REALIZADAS Y NO REALIZADAS): ". " FECHA: ".date('d-m-Y') . " HORA: ".date('H:i'));
