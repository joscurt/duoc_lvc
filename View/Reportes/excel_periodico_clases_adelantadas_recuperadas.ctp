<?php
	...
	$objPHPExcel->getProperties()->setCreator("LISTADO DE CLASES: ".date('dmYH:i'))
                     ->setLastModifiedBy("LVC")
                     ->setTitle("LISTADO DE CLASES: ".date('dmYH:i'))
                     ->setSubject("LISTADO")
                     ->setDescription("Listado de clases")
                     ->setKeywords("office 2007 openxml php")
                     ->setCategory("Listado de clases");
                 	##
	...
	$objPHPExcel->setActiveSheetIndex()->setCellValue('B2', "REPORTES PERI&Oacute;DICOS DE CLASES ADELANTADAS Y RECUPERADAS (REALIZADAS Y NO REALIZADAS): ". " FECHA: ".date('d-m-Y') . " HORA: ".date('H:i'));
