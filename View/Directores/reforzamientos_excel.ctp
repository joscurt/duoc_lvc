<?php
    ...
    foreach ($datos_tabla as $detalle): 
        ...
        $objPHPExcel->setActiveSheetIndex()->setCellValue('F'.$fila, $detalle['ProgramacionClase']['COD_JORNADA'] == 'D' ? 'Diurno' : 'Vespertino');
        ...
        $objPHPExcel->setActiveSheetIndex()->setCellValue('M'.$fila, $detalle['Detalle']['DETALLE']);
        $objPHPExcel->setActiveSheetIndex()->setCellValue('N'.$fila, $detalle['SubEstado']['NOMBRE']);
