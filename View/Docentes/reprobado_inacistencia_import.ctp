...
<form 
	action="<?php echo $this->Html->url(array('action'=>'saveReprobadoInasistenciaImport',$asignatura_horario['AsignaturaHorario']['COD_ASIGNATURA_HORARIO'])); ?>" method="POST">
	<div class="card">
				...
				<div class="table-responsive" style="overflow-x: hidden;">
					...
					<div class="col-md-12">
						<table class="table table-striped table-bordered table-hover" id="tabla-ri">
							...
							<tbody>
								<?php 
									foreach ($alumno_im as $key => $value): 
										$porcentaje = 0;
								...
								?>
									<tr >
										...
										<td class="text-center"><?php echo strtoupper($value['RI_IM']['RUT']); ?></td>
										<td class="text-left"><?php echo strtoupper($value['Alumno']['APELLIDO_PAT']); ?></td>
										<td class="text-left">
											<?php echo strtoupper($value['Alumno']['APELLIDO_MAT']); ?>
										</td>
