<form method="POST">
	<div class="modal-header" >
		...
		<h4 style="border-bottom: 1px solid #0c253d; padding-bottom: 5px;" class="modal-title">Nuevo Registro</h4>
	</div>
	<br>
		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="form-group">
					...
					<input type="text" class="form-control input_motivo" name="data[<?php echo $model ?>][NOMBRE]" placeholder="Ingrese nombre">
				</div>
			</div>
		</div>
	</div>
