<p>Estimado(a) <strong><?php echo $director['Director']['NOMBRES'].' '.$director['Director']['APELLIDO_PAT'].' '.$director['Director']['APELLIDO_MAT'] ?></strong>,</p>
<br>
<p>Usted ha autorizado la solicitud de adelantar una clase seg&uacute;n lo siguiente:<p>
<?php 
