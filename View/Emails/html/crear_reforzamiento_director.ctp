<p>Estimado(a) director <strong><?php echo $director['Director']['NOMBRES'].' '.$director['Director']['APELLIDO_PAT'].' '.$director['Director']['APELLIDO_MAT']; ?></strong>:</p>
<br>
<p>Se ha creado una solicitud de una clase de reforzamiento seg&uacute;n lo siguiente:</p>
<?php 
...
<br>
<p>Para su <strong>autorizaci&oacute;n</strong> o <strong>rechazo</strong> debe ingresar a la plataforma.</p>
<p>Atte.</p>
<p>Duoc UC</p>