<p>Estimado(a) alumno(a) <strong><?php echo $alumno['Alumno']['NOMBRES'].' '.$alumno['Alumno']['APELLIDO_PAT'].' '.$alumno['Alumno']['APELLIDO_MAT']; ?></strong>:</p>
<br>
<p>Se ha agendado una clase de reforzamiento seg&uacute;n lo siguiente:</p>
<?php 
