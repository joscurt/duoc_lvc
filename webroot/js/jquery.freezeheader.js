    ...
    $.fn.freezeHeader = function (params) {
        ...
        function freezeHeader(elem) {
            ...
            if (elem.length > 0 && elem[0].tagName.toLowerCase() == "table") {
                ...
                if (params && params.height !== undefined) {
                    obj.divScroll = '<div id="hdScroll' + obj.id + '" style=" overflow-y: scroll">';
                ...
                obj.scroller.on('scroll', function () {
                    if ($('#hd' + obj.id).length == 0) {
                        obj.grid.before('<div id="hd' + obj.id + '"style="z-index: 100;"></div>');
                    }
        ...
        function cloneHeaderRow(obj) {
            ...
            if (params && params.height !== undefined) {
                ...
                {
                   obj.container.css("top", obj.scroller.offset().top + 65 + "px");
                }
            ...
            obj.container.css("position", "absolute");
               ...
               obj.container.css("top", obj.scroller.find("thead > tr").innerHeight() + "px");
                obj.container.css("bottom", obj.scroller.find("thead > tr").innerHeight() + "px");
                obj.container.css("position", "absolute");
